...
void CheckEq(const PackedPoint& lhs, const PackedPoint& rhs, float precision = 1e-6) {
    for (int i = 0; i < 8; i++) {
...
void CheckEq(const PackedSegment& lhs, const PackedSegment& rhs, float precision = 1e-6) {
    for (int i = 0; i < 8; i++) {
